...
let
  sources = {
    ...
    "node-releases-1.1.33" = {
      ...
      version = "1.1.33";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-releases/-/node-releases-1.1.33.tgz";
        sha512 = "I0V30bWQEoHb+10W8oedVoUrdjW5wIkYm0w7vvcrPO95pZY738m1k77GF5sO0vKg5eXYg9oGtrMAETbgZGm11A==";
      };
    };
    "node-wav-0.0.2" = {
      name = "node-wav";
