...
let
  sources = {
    ...
    "vm-browserify-1.1.1" = {
      ...
      version = "1.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/vm-browserify/-/vm-browserify-1.1.1.tgz";
        sha512 = "VdaJ/et1OKy9VDEqH6epLQ/DlNMuHvtDgwjPYvDvqNOlgFSMAL4ucZvyIpz0D4x5qT+8wCSK19YjWicJuc00hQ==";
      };
    };
    "w-json-1.3.9" = {
      name = "w-json";
